...
export const REPORTS: ReportDefinition[] = [
  ...
  },
  {
    ...
    blurb: 'שימושים, הכנסה שהתקבלה דרך המבצע, סכום הנחה, AOV, לקוחות חדשים, Conversion ורווחיות.',
    priority: 'later',
    href: null,
  },
  {
  ...
  // כספים והתאמות
  {
    ...
    title: 'תשלומים',
    blurb: 'אשראי/Bit/Apple Pay/Google Pay — הצלחות, כשלים, ניסיונות חוזרים, Pending, זיכויים.',
    priority: 'later',
    href: null,
  },
  {
  ...
  },
  {
    ...
    blurb: 'מסמכים שהופקו, נכשלו, ממתינים, מסמכי זיכוי, סוג מסמך, סכומים ופערים.',
    priority: 'later',
    href: null,
  },
  {
  ...
  },
  {
    ...
    blurb: 'מסך אחד שמרכז תשלום ללא מסמך, מלאי שלילי, הזמנה שולמה ולא טופלה, משלוח באיחור, Webhook כושל.',
    priority: 'important',
    href: null,
  },
];
