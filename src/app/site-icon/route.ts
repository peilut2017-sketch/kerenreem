...
/** אותו סימן — שלושה ספרים על מדף — לשעה שאין לוגו. [1.7] צבעי הפלטה
 *  המרוענת: חֵמר, אורן ופליז על נייר, כדי שאייקון הלשונית יתאים למותג. */
const FALLBACK_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" role="img" aria-label="מכון קרן רא&quot;ם">
  ...
  <rect x="6" y="7" width="5" height="17" fill="#9a4630"/>
  <rect x="13" y="10" width="5" height="14" fill="#1c3a2c"/>
  <rect x="20" y="8" width="5" height="16" fill="#bf9450"/>
  <rect x="5" y="24" width="22" height="1.5" fill="#191b16"/>
</svg>`;
