...
export async function submitContact(
  ...
  //
  // הנפילה ללקוח האנונימי רלוונטית *רק* לסביבה שבה מיגרציה 45 טרם הורצה
  // (מדיניות ה-INSERT הישנה עדיין קיימת): שם הכתיבה מצליחה גם בלי service
  // key. אחרי מיגרציה 45 המפתח נדרש — כמו לכל שאר זרימות המסחר בייצור —
  // ובלעדיו ה-RLS דוחה, וההודעה למטה מסבירה ללקוח שהמשלוח נכשל.
